...
const main = document.querySelector('.main'),
        ...
        slide = document.querySelectorAll('.main__slide'),
        slideImage = document.querySelector('.main__slide-img'),
        slideTitle = document.querySelector('title'),
        slideDescription = document.querySelector('.description'),
...
main.addEventListener('scroll', () => {
    if(scroll){
        // slideWrapper.style.transform = 'translateY(-1100px)'
    }
